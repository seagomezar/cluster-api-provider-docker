...
import (
	...
	infrastructurev1alpha1 "github.com/seagomezar/cluster-api-provider-docker/api/v1alpha1"
	"github.com/seagomezar/cluster-api-provider-docker/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f29aa0e7.cluster.x-k8s.io",
